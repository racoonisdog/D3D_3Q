...
//VSFullScreenOut ToneMap_vs(uint vertexId : SV_VertexID)
//{
//    //VSFullScreenOut outvalue;
...
//    //outvalue.Pos = float4(pos[vertexId], 0.0f, 1.0f);
//    //outvalue.UV = uv[vertexId];
//    //return outvalue;
    
    
//}

PS_INPUT_QUAD ToneMap_vs(VS_INPUT_QUAD input)
{

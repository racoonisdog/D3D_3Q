...
ImageBasedLighting::ImageBasedLighting(HINSTANCE hInstance) : GameApp(hInstance)
{
...
void ImageBasedLighting::SetMatrix()
{
...
void ImageBasedLighting::SanitizeCamera(Vector3& eye, Vector3& target, Vector3& up)
{
	// eye == target 방지
...
bool ImageBasedLighting::Initialize(UINT Width, UINT Height)
{
...
bool ImageBasedLighting::InitD3D()
{
	// 초기화
	Reset();
	// 결과값.
...
void ImageBasedLighting::UninitD3D()
{
...
void ImageBasedLighting::UninitSkyBox()
{
...
bool ImageBasedLighting::InitScene()
{
	HRESULT hr = 0; // 결과값.
...
bool ImageBasedLighting::InitSkyBox()
{
	HRESULT hr = 0; // 결과값.
	ID3D10Blob* errorMessage = nullptr;	 // 컴파일 에러 메시지가 저장될 버퍼.	
...
void ImageBasedLighting::RenderSkyBox()
{
...
void ImageBasedLighting::UninitScene()
{
...
bool ImageBasedLighting::InitImGUI()
{
	IMGUI_CHECKVERSION();
	ImGui::CreateContext();
...
void ImageBasedLighting::UninitImGUI()
{
...
void ImageBasedLighting::RenderGUI()
{
...
bool ImageBasedLighting::InitEffect()
{
...
LRESULT ImageBasedLighting::WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
...
void ImageBasedLighting::SetLightVP()
{
...
void ImageBasedLighting::SetHoldLight()
{
...
void ImageBasedLighting::DebugMatrix4x4(const char* label, const Matrix& matrix)
{
...
void ImageBasedLighting::SetDebugLightFrustum()
{
...
void ImageBasedLighting::RenderDebugLightFrustum()
{
...
void ImageBasedLighting::SetPBRValue(std::shared_ptr<ModelLoader> mesh)
{
...
void ImageBasedLighting::SetIBLValue(std::shared_ptr<ModelLoader> mesh)
{
	if (useIBL)
	{
...
void ImageBasedLighting::SetSkyBoxMap()
{
	switch (IBLvalue)
	{
	case IBLType::SkyBox:
...
void ImageBasedLighting::SetIBLMap()
{
	switch (IBLvalue)
	{
	case IBLType::SkyBox:
